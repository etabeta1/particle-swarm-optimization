...
std::chrono::duration<double> measure(int threads, int particles, std::shared_ptr<Swarm::ObjectiveFunction<float, 2>> fitness, const Swarm::ChaosMap<float, 2> &chaosMap)
{
    ...
    Swarm::Optimizers::CHOPSOOptimizer<T, dim> swarm(fitness, initial_best, a, b, nN, nC, chaosMap, max_iterations, "/work/u10768804/benchmark/positions_benchmark_chopso_ackley_dist_00_r50_p28_n60_i30.txt");
...
int main()
{
    ...
    std::ofstream benchmark_file("/work/u10768804/benchmark/benchmark_chopso_ackley_dist_00_r50_p28_n60_i30.json");
