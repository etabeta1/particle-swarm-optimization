...
std::chrono::duration<double> measure(int threads, int particles, std::shared_ptr<Swarm::ObjectiveFunction<float, 2>> fitness, const Swarm::ChaosMap<float, 2> &chaosMap)
{
    ...
    Swarm::Optimizers::GENETICOptimizer<T, dim> swarm(fitness, initial_best, a, b, nN, nC, chaosMap, max_iterations, "/work/u10768804/benchmark/positions_benchmark_elpso_drop_dist_10_r95_p28_n60_i30.txt");
...
int main()
{
    ...
    std::ofstream benchmark_file("/work/u10768804/benchmark/benchmark_elpso_drop_dist_10_r95_p28_n60_i30.json");
